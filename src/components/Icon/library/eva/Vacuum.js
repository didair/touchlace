...
export const Vacuum = ({ className = '' }) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" x="0px" y="0px" className={`eva-icon ${className}`}>
			<path d="M32,8A24,24,0,1,0,56,32,24.028,24.028,0,0,0,32,8Zm0,2a21.979,21.979,0,0,1,17.734,9H37.91a5.993,5.993,0,0,0-11.82,0H14.266A21.979,21.979,0,0,1,32,10Zm4,10a4,4,0,1,1-4-4A4,4,0,0,1,36,20ZM32,54A21.983,21.983,0,0,1,12.964,20.993c.013,0,.023.007.036.007H26.09a5.993,5.993,0,0,0,11.82,0H51.04A21.983,21.983,0,0,1,32,54Z"/>
			...
			<path d="M32,42a3,3,0,0,0-3,3v4a3,3,0,0,0,6,0V45A3,3,0,0,0,32,42Zm0,2a1,1,0,0,1,1,1v1H31V45A1,1,0,0,1,32,44Zm0,6a1,1,0,0,1-1-1V48h2v1A1,1,0,0,1,32,50Z"/>
